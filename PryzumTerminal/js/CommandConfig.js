...
legionlist = [
 ...
 "<span class=\"neofetchcolour4\">╚══════╝╚══════╝ ╚═════╝ ╚═╝ ╚═════╝ ╚═╝  ╚═══╝</span>",
  ...
  // "<h1 class='h1ns'><span class=\"neofetchcolour4\">&nbsp;╚══════╝╚══════╝░╚═════╝░╚═╝░╚════╝░╚═╝░░╚══╝</span></h1>",
  '<br>',
    "<span class=\"color5\">          The Gun List        </span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│ Knuckle Dusters │ $2,500   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│      Knife      │ $3,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│  Switch Blade   │ $3,500   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│   SNS Pistol    │ $3,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│ SNS Pistol MK2  │ $4,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│     Pistol      │ $5,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│ Vintage Pistol  │ $6,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│     FNX 45      │ $8,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│  Combat Pistol  │ $8,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  "<span class=\"color5\">│  Heavy Pistol   │ $8,000   │</span>",
  "<span class=\"color5\">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>",
  '<h2>Interested in purchasing? Contact 999-999-9999 for more info<h2>',
  // '<h2>You are a criminal, you should of never been trusted to run for Mayor<h2>',
  // '<h2>We know the cops wont look into you so we will<h2>',
  // '<h2>WATCH YOUR ASS THE NEXT TIME YOU SHOW YOUR FACE IN PUBLIC!!!!!!!!!!<h2>',
